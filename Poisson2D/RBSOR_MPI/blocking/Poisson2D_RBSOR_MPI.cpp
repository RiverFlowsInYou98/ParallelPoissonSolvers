...
void exchangeBoundaryDataBlocking(const MPIEnv &env, const Subdomain &subdomain, std::vector<double> &local_sol,
...
int main(int argc, char **argv)
{
    ...
    do
    {
        ...
        for (int color = 0; color <= 1; color++)
        {
            ...
            exchangeBoundaryDataBlocking(env, subdomain, sol, received_top_boundary_data, received_bottom_boundary_data,
